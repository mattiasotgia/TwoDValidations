events=(29413 35855 34896 35248 32761 42265 32735)
files=(
...
do
    ...
    ./get_file.sh ${files[i]} monitor_stage1_standard.fcl 9435:1:${events[i]} /exp/icarus/data/users/msotgia/hitTuning/wireDrawingTmp/pandoraDisplayLatest/TestingPR/e${events[i]}_default.root

    ./get_file.sh ${files[i]} monitor_stage1_standard_no_pt.fcl 9435:1:${events[i]} /exp/icarus/data/users/msotgia/hitTuning/wireDrawingTmp/pandoraDisplayLatest/TestingPR/e${events[i]}_no_pt.root
